...
class App extends Component {
  state = {searchInput: '', initialList: initialTracksList}
  ...
  onClickDeleteBtn = id => {
    ...
    const getUpdatedList = initialList.filter(eachItem => eachItem.id !== id)

    this.setState({initialList: getUpdatedList})
  }
